...
public class Customer extends JPanel
{
	...
	public Customer(StaffPage obj)
	{
		...
		JLabel lblCity = new JLabel("C.N.I.C");
		...
		btnNewButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{
					 JOptionPane.showMessageDialog(Customer.this, "Please fill/select all the fields", "Error", JOptionPane.ERROR_MESSAGE);		
				}
				else
				{

					String query="insert into customer values(?,?,?,?,?)";
					String query1="select * from customer where CustomerId = ?";
					String query2="update customer set CustomerName=?,Address=?,CNIC=?,PhoneNo=? where CustomerId=?";
					int flag=0,flag1=0;
					...
					if(flag==1)
					{
						JOptionPane.showMessageDialog(Customer.this, "Customer is added", "Added", JOptionPane.INFORMATION_MESSAGE);
						reset1();
					}
					else
					{
						JOptionPane.showMessageDialog(Customer.this, "Customer is not added", "Error", JOptionPane.ERROR_MESSAGE);
					}
				}
		...
		btnSearch.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(s1.length()==0)
				{
					JOptionPane.showMessageDialog(Customer.this, "Please fill the ID to be searched", "Error", JOptionPane.ERROR_MESSAGE);	
				}
				else
				{
		...
		btnReset_1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(flag==1)
				{
					JOptionPane.showMessageDialog(Customer.this, "Customer is deleted", "Added", JOptionPane.INFORMATION_MESSAGE);
					reset1();
				}
				else
				{
					JOptionPane.showMessageDialog(Customer.this, "Customer is not deleted", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		add(btnReset_1);
