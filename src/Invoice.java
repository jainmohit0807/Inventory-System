	...
	public Invoice()
	{
		...
		btnNewButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{
					 JOptionPane.showMessageDialog(Invoice.this, "Please fill/select all the fields", "Error", JOptionPane.ERROR_MESSAGE);		
				}
				else
				{
					...
					try
					{
						 ...
						 if(flag==1)
						 {
							 JOptionPane.showMessageDialog(Invoice.this, "Product is added", "Added", JOptionPane.INFORMATION_MESSAGE);
								reset1();
						 }
						 else
						 {
							 JOptionPane.showMessageDialog(Invoice.this, "Product is not added", "Error", JOptionPane.ERROR_MESSAGE);
						 }
					} 
					catch (Exception e) 
					{
		...
		JLabel lblPurchaseId = new JLabel("Invoice ID");
