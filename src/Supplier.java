...
public class Supplier extends JPanel
{
	...
	public Supplier(StaffPage obj)
	{
		setLayout(null);
		
		JLabel lblDate = new JLabel("Supplier name");
		...
		btnNewButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{
					 JOptionPane.showMessageDialog(Supplier.this, "Please fill/select all the fields", "Error", JOptionPane.ERROR_MESSAGE);		
				}
				else
				{
					...
					String query2="update supplier set SupplierName=?,Address=?,CNIC=?,PhoneNo=? where SupplierId=?";
					int flag=0,flag1=0;
					...
					if(flag==1)
					{
						JOptionPane.showMessageDialog(Supplier.this, "Supplier is added", "Added", JOptionPane.INFORMATION_MESSAGE);
						reset1();
					}
					else
					{
						JOptionPane.showMessageDialog(Supplier.this, "Supplier is not added", "Error", JOptionPane.ERROR_MESSAGE);
					}
				}
		...
		btnSearch.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(s1.length()==0)
				{
					JOptionPane.showMessageDialog(Supplier.this, "Please fill the ID to be searched", "Error", JOptionPane.ERROR_MESSAGE);	
				}
				else
				{
		...
		btnReset_1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(flag==1)
				{
					JOptionPane.showMessageDialog(Supplier.this, "Supplier is deleted", "Added", JOptionPane.INFORMATION_MESSAGE);
					reset1();
				}
				else
				{
					JOptionPane.showMessageDialog(Supplier.this, "Supplier is not deleted", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		add(btnReset_1);
